...
## License
This repository does not include a license file. Add one (e.g. MIT) if you intend to publish or share the project publicly.

----
If you'd like, I can also:
- Add example `.env` loader and `.env.example` file
- Wire a `make`/`invoke` script for common tasks
- Add CI steps (GitHub Actions) to run tests automatically

Tell me which of those you'd like next.
# Patient Simulator Bot

A voice bot that tests Pretty Good AI's healthcare agent by simulating patient calls using Twilio, OpenAI Whisper, ChatGPT, and ElevenLabs.
...
```bash
git clone https://github.com/yourusername/patient-simulator-bot
cd patient-simulator-bot